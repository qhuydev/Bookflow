...
public class AuthenticationController {
 private final UserLoginService login; private final AuthenticationProperties props;
 public AuthenticationController(UserLoginService login,AuthenticationProperties props){this.login=login;this.props=props;}
